# IR Payload Identification Documentation
...
- Set up the environment variables and paths in the notebook:
   - `model_path`: Path to the trained YOLOv12m model weights (yolov12trainingpayloadIR.pt)
...
- **Batch Size**: 16
- **Model File**: yolov12trainingpayloadIR.pt
