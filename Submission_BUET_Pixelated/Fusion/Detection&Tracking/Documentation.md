# RGB-IR Fusion Detection & Tracking Documentation
...
- Set up the environment variables and paths in the notebook:
   - `weights_path`: Path to the YOLOv5 model weights (yolov5m_fusion.pt)
...
### Detection Approach:
- **Base Model**: YOLOv5m architecture fine-tuned with RGB IR image fusion for drone and bird detection
